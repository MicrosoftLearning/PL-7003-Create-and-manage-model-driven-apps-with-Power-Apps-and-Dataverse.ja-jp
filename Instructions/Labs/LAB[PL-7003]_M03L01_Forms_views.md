...
1. **[ラベル]** に「`Showings`」と入力し、**[名前]** に「`showingTab`」と入力します。
...
1. **[カスタム列]** セクションまで下へスクロールします。

1. **[不動産物件]** テーブルを選択します。 すべての特権のアクセス レベルを **[組織]** に変更します。

    ![セキュリティ ロールの不動産物件の権限。](../media/security-role.png)

1. **[内覧]** テーブルを選択します。 すべての特権のアクセス レベルを **[組織]** に変更します。
