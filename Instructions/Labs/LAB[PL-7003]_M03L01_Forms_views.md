...
1. **保存して閉じる** を選択します。 ソリューションに戻り、**[完了]** を選択して変更を取得します。
...
1. ビュー デザイナーを**閉じて**、**[完了]** を選択します。


### タスク 4.2 – 不動産物件の簡易検索ビュー

1. **[不動産物件の簡易検索]** ビューを選択し、**[コマンド]** メニュー (...) を選び、**[編集]** > **[新しいタブで編集]** の順に選択します。
